...
class M3USBSerial:
    ...
    def connect(self) -> bool:
        ...
        try:
            ...
            # Wait for ESP32B boot and start background reader FIRST
            time.sleep(1.0)  # Wait for ESP32B boot messages

            # Start background reader thread BEFORE sending commands
    ...
    def home(self) -> Tuple[bool, str]:
        ...
        if response and 'HOMED' in response:
